...
///
///
/// Creates a [DateInputFormField] with an [InputDecoration] and validator function.
/// ```dart
/// DateInputFormField(
...
///
/// default validator is [DateInputFormField._defaultValidator].
/// default [autovalidateMode] is [AutovalidateMode.onUserInteraction].
/// default [format] is 'yyyy-MM-dd'.
///
/// Compare this snippet from example/lib/main.dart:
class DateInputFormField extends FormField<(String, DateTime?)> {
  /// Creates a [DateInputFormField].
  ...
  /// The default value for [FormField.validator] of [DateInputFormField] is
  /// [DateInputFormField._defaultValidator].
  ///
...
class _DateFormFieldState extends FormFieldState<(String, DateTime?)> {
  ...
  DateInputFormField get _textFormField => super.widget as DateInputFormField;
  ...
  @override
  void didUpdateWidget(DateInputFormField oldWidget) {
